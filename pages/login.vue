  ...
  <div class="fixed inset-0 z-10 overflow-y-auto bg-white">
    <div class="flex items-center justify-center min-h-screen text-center">
      ...
      >
        <div class="pb-2 bg-white">
          <div class="flex-col items-center sm:flex">
            <div class="mt-3 mb-1 text-center sm:text-left">
              <h4
                class="pt-1 text-3xl font-black leading-6 text-gray-700"
                id="modal-headline"
              >
                Sign in
              </h4>
        ...
        <div
          class="px-4 py-2 pt-3 mt-1 text-xs bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse"
        >
          <button
        ...
        <div class="px-4 text-xs bg-gray-50 sm:px-6 sm:flex-row-reverse">
          <form class="mt-4">
            ...
            <label for="password" class="block mt-3">
              <span class="font-sans text-sm text-gray-700"> Password </span>
              <input
                type="password"
                id="password"
                name="password"
            ...
            <div
              class="justify-start w-full px-4 mt-2 font-sans text-xs leading-6 text-center text-gray-500"
            >
              <a
            ...
            <div class="mt-6">
              <button
                type="submit"
                class="w-full px-4 py-2 text-sm text-center text-white bg-blue-500 rounded-md hover:bg-indigo-500"
              >
                Sign in now
              </button>
            </div>
