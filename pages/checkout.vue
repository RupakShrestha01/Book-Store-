                ...
                <ul class="-my-4 divide-y divide-gray-200">
                  <li class="flex items-center justify-between py-4">
                    <div class="flex items-start">
                      <img
                        class="flex-shrink-0 object-cover w-32 h-16 rounded-lg"
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS83lc-oiadY8DUf6rgmXJKHBm6HVugAgs1WA&usqp=CAU"
                        alt=""
                      />
